...
// const PersonalInfo = () => {
//   return (
//     // <section classNameName="py-20 2xl:py-40 overflow-hidden bg-[#041C32]">
//     //   <div classNameName="container px-4 mx-auto">
//     //     <div classNameName="max-w-3xl mx-auto text-center p-5">
//     //       <h2 classNameName="mb-14 text-6xl lg:text-7xl font-bold font-heading text-white">I am Anandkumar NS </h2>
//     //       <div classNameName="inline-flex mb-14 lg:mb-20 items-center">
//     //         <div classNameName="text-left"></div>
//     //       </div>
//     //     </div>
//     //     <div classNameName="relative h-96 mb-20 flex justify-center items-center">
//     //       <img classNameName="h-auto w object-cover" src="./anand.png" alt=""/>
//     //       <div classNameName="max-w-xl mx-auto p-10 flex items-end justify-end">
//     //         <p classNameName="mb-6 text-left text-xl text-gray-200">Hello, I'm Anandkumar NS, a passionate Computer Science engineer based in Chennai. I have a deep fascination for exploring new technologies and tools that shape our ever-evolving digital landscape. I firmly believe in the adage that the only constant in the world is change, and I embrace it wholeheartedly.
...
//     //       </div>
//     //     </div>
//     //     <p classNameName="mb-6 text-left text-xl text-gray-200">Throughout my journey, I have enjoyed immersing myself in various aspects of computer science, including software development, system architecture, and emerging technologies. This diverse exposure has not only broadened my understanding but also fueled my curiosity to explore further.</p>
//     //     <p classNameName="mb-6 text-left text-xl text-gray-200">With a solid foundation in computer science and an insatiable thirst for learning, I am committed to leveraging technology to drive innovation and make a meaningful impact. I am excited about the endless possibilities that lie ahead and look forward to collaborating with like-minded individuals and organizations on exciting projects.
//     //       Thank you for visiting my portfolio, and I invite you to join me on this exhilarating journey of exploration and growth.</p>
//     //   </div>
//     // </section>
// {/* <div className="relative z-20 overflow-hidden pt-12 pb-28 bg-[#041C32]">
...
//           <img className="w-full md:w-auto rounded-lg transform hover:scale-105 transition ease-in-out duration-1000" src="./anand.png" alt=""/>
//         </div>
...
//         <h1 className="mb-7 text-6xl md:text-8xl xl:text-10xl font-bold font-heading tracking-px-n leading-none">Hi, I am Anandkumar NS</h1>
//         <p className="mb-9 text-lg text-gray-100 font-medium md:max-w-md">Hello, I'm Anandkumar NS, a passionate Computer Science engineer based in Chennai. I have a deep fascination for exploring new technologies and tools that shape our ever-evolving digital landscape. I firmly believe in the adage that the only constant in the world is change, and I embrace it wholeheartedly. Having recognized the prominent role of computers in today's modern world, I find great joy in delving into the intricacies of this fascinating field. By continuously expanding my knowledge and skills, I strive to stay ahead of the curve and prepare myself for the future. Throughout my journey, I have enjoyed immersing myself in various aspects of computer science, including software development, system architecture, and emerging technologies. This diverse exposure has not only broadened my understanding but also fueled my curiosity to explore further. With a solid foundation in computer science and an insatiable thirst for learning, I am committed to leveraging technology to drive innovation and make a meaningful impact. I am excited about the endless possibilities that lie ahead and look forward to collaborating with like-minded individuals and organizations on exciting projects.           Thank you for visiting my portfolio, and I invite you to join me on this exhilarating journey of exploration and growth.</p>
...
const PersonalInfo = () => {
  return (
    // 
//     <section className="py-36 bg-[#041C32] overflow-hidden">
...
//         <div className="relative max-w-max mx-auto lg:ml-auto lg:mr-0 overflow-hidden rounded-4xl">
          // <img className="transform hover:scale-105 transition ease-in-out duration-1000" src="./anand.png" alt=""/>
...
//           <p className="mb-8 font-sans text-sm text-indigo-600 font-semibold uppercase tracking-px">HEY,  I'M</p>
//           <h2 className="mb-8 text-6xl md:text-8xl xl:text-10xl font-bold font-heading tracking-px-n leading-none text-white">Anandkumar                       NS</h2>
//           <p className="mb-7 text-lg text-gray-200 font-medium">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat.</p>
//           <p className="text-gray-600 font-medium">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sit velit risus sit sed massa. Vivamus vel lorem egestas.</p>
//         </div>
//       </div>
//     </div>
//   </div>
